    ...
    const handleCart = async (product) => {
        try {
            ...
            if (response.data.status) {
                ...
                // Initialize the toast after setting the product name
                setTimeout(() => {
                            ...
                            <div className="col-lg-4 col-md-6 col-12 my-3" key={index}>
                                <div className="product p-3 text-white rounded-4 h-100">
                                    <div className="productname d-flex align-items-center">
                                        ...
                                        {product.type.toLowerCase() === "egg" && <img src={egglogo} className="img-fluid me-2 mb-3" style={{ width: "30px", height: "30px" }} alt="veg" />}
            ...
            <div className="toast-container position-fixed bottom-0 end-0 p-3">
                <div id="liveToast" className="toast" role="alert" aria-live="assertive" aria-atomic="true">
                    <div className="toast-header">
                        <img src={veglogo} className="rounded me-2" alt="veg logo" />
